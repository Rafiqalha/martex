...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const Color primaryGreen = Color(0xFF065F46);
    const Color secondaryGreen = Color(0xFF10B981);
    const Color lightCard = Color(0xFFF0FDF4);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildFeatureCard(
                      ...
                      subtitle: "Vaksinasi wajib dasar",
                      color: warningColor,
                    ),
                    const SizedBox(height: 30),
                    SizedBox(
